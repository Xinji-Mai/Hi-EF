...
from data_prepro_sirv_second_test_rr import data_prepro
devices=[1]
...
checkpoint = torch.load('sec_checkpoint/sirvsecond.ckpt', map_location = device) # 这里假设您的checkpoint文件名是best-checkpoint.ckpt，您可以根据您的实际文件名来修改
