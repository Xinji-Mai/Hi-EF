...
from model_sirv_first import AICLIP
from data_prepro_sirv_first_rr import data_prepro

devices = [1]

mfilename = 'mmmm_va_rr'
ckp = "sec_checkpoint/mmmm_va_rr.ckpt"
...
def run(experiment_name: str,
    ...
    trainer.fit(model, train_dataloaders=train_loader,
                val_dataloaders=val_loader,ckpt_path=ckp)
