...
from model_sirv_first_v import AICLIP
...
checkpoint = torch.load('sec_checkpoint/mmmm_v_rr.ckpt', map_location = device) # 这里假设您的checkpoint文件名是best-checkpoint.ckpt，您可以根据您的实际文件名来修改
