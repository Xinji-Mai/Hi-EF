...
class ResNet(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        image_feature_1 = feature_1_f + feature_1_o + feature_1_p
        image_feature_2 = feature_2_f + feature_2_o + feature_2_p
        image_feature_3 = feature_3_f + feature_3_o + feature_3_p

        feature = torch.stack([image_feature_1, image_feature_2, image_feature_3], dim=0)
    ...
    def on_test_epoch_end(self) -> None:
        ...
        display_cls_confusion_matrix(self.confusion_matrix, labels_7, test_number_7, name_7,'r18lstm_add_trans')
