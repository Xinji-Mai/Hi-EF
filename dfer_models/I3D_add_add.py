...
class InceptionI3d(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        x = feature_1_f + feature_2_f + feature_3_f + feature_1_o + feature_2_o + feature_3_o + feature_1_p + feature_2_p + feature_3_p
    ...
    def on_test_epoch_end(self) -> None:
        ...
        display_cls_confusion_matrix(self.confusion_matrix, labels_7, test_number_7, name_7,'i3d_add_add')
