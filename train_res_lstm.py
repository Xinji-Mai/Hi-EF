...
from dfer_models.r18_lstm import resnet18 #vgg16 + lstm
...
model = resnet18(end2end=True, num_classes=7, at_type='self_relation-attention')
# model = TwoVGG13LSTM(num_classes=7)

from data_prepro_sirv_other_train import data_prepro
...
checkpoint = torch.load("sec_checkpoint/reslstm.ckpt", map_location = device) # 这里假设您的checkpoint文件名是best-checkpoint.ckpt，您可以根据您的实际文件名来修改 14ep
