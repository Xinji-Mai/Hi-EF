...
class AICLIP(pl.LightningModule):
    ...
    def parse_batch_train(self, batch):
        ...
        f_frames_3, o_frames_3, daudio_3, dtext_3, label_3, label_4, valid_list_o_3, valid_list_f_3 = batch
        return f_frames_3, o_frames_3, daudio_3, dtext_3, label_3, label_4, valid_list_o_3, valid_list_f_3
    ...
    def forward(self,batch):
        ...
        f_frames_3, o_frames_3, daudio_3, dtext_3, label_3, label_4, valid_list_o_3, valid_list_f_3 = self.parse_batch_train(batch)
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=8, threshold=0.001)
    ...
    def on_test_epoch_end(self) -> None:
        ...
        name_7 = 'SIRV (7 classes)'
        display_cls_confusion_matrix(self.confusion_matrix,labels_7,test_number_7 , name_7,'mmmm_34')
