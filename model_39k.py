...
class AICLIP(pl.LightningModule):
    ...
    def forward(self,batch):
        ...
        valid_list_o = valid_list
        valid_list_f = valid_list
    ...
    def test_step(self, batch, batch_idx):
        ...
        if '0' in report:
            war_0 = report['0']['precision']
        if '1' in report:
            war_1 = report['1']['precision']
        if '2' in report:
            war_2 = report['2']['precision']
        if '3' in report:
            war_3 = report['3']['precision']
        if '4' in report:
            war_4 = report['4']['precision']
        if '5' in report:
            war_5 = report['5']['precision']
        if '6' in report:
            war_6 = report['6']['precision']
